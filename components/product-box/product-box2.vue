    ...
    <div class="img-block">
      ...
      <div class="front">
        <nuxt-link :to="{ path: '/product/sidebar/' + product.id }">
          <img :src='getImgUrl(imageSrc ? imageSrc : product.images[0].src)' :id="product.id" class="img-fluid bg-img"
            :alt="product.title" :key="index" />
        </nuxt-link>
      </div>
      <div class="back">
        <nuxt-link :to="{ path: '/product/sidebar/' + product.id }">
          <img :src='getImgUrl(product.images[1].src)' :id="product.id" class="img-fluid bg-img" :alt="product.title"
            :key="index" />
        </nuxt-link>
      </div>
      <div class="cart-info">
        ...
        <a href="javascript:void(0)" title="Comapre" @click="addToCompare(product)" variant="primary">
