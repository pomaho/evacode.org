<template>
 <Header/>
    <div>
                    ...
                    <div class="row">
                                    ...
                                    <swiper :breakpoints="swiperOption.breakpoints" :slidesPerView="2"
                                        ...
                                        <swiper-slide class="swiper-slide" v-for="(product, index) in getDetail.images"
                                            ...
                                            <img :src="getImgUrl(product.src)" :id="product.image_id"
                                                class="img-fluid " alt="product.alt" @click="slideTo(index)" />
                                        </swiper-slide>
                                    </swiper>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5 col-sm-10 order-up">
                            <swiper @swiper="onSwiper" :slidesPerView="1" :spaceBetween="20" class="swiper-wrapper">
                                <swiper-slide class="swiper-slide" v-for="(product, index) in getDetail.images"
                                    :key="index" :class="slideId == index ? 'product-slider-active' : ''">
                                    <img :src="getImgUrl(product.src)" :id="product.image_id" class="img-fluid "
                                        :alt="product.alt" />
                                </swiper-slide>
                            </swiper>
                        </div>
        ...
        <div class="modal fade bd-example-modal-md theme-modal" id="modal-1" aria-hidden="true" tabindex="-1"
