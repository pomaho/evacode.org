...
<Header/>
  <div>
            ...
            <div class="col-lg-4">
              ...
              <div class="row">
                <div class="col-12 slider-nav-images">
                  <swiper :slidesPerView="3" :spaceBetween="20" :centeredSlides="false" class="swiper-wrapper">
                    <swiper-slide class="swiper-slide" v-for="(product, index) in getDetail.images" :key="index"
            ...
            <div class="col-lg-4">
              <div class="product-right product-form-box">
                ...
                <div class="product-description border-product">
                  ...
                  <h6 class="product-title three-col-text d-flex justify-content-between">
                    select size
                    <span>
    ...
    <div class="modal fade bd-example-modal-lg theme-modal" id="modal-1" aria-hidden="true" tabindex="-1" role="dialog"
            ...
            <div class="modal-body p-0">
              <div class="bg-white position-relative">
                <div class="modal-header position-relative">
                  ...
                  <button class="close btn-close background-none" type="button" data-bs-dismiss="modal">
                    <span>×</span>
                  </button>
                </div>
                <div class="p-3">
