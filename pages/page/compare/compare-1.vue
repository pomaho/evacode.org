                ...
                <table class="table">
                    ...
                    <tr class="th-compare">
                      ...
                      <th class="item-row" v-for="(item, index) in compare" :key="index">
                        <button type="button"
                          ...
                          @click="removeCompareItem(item)">Remove</button>
                      </th>
                    </tr>
                  </thead>
                  <tbody id="table-compare">
                    ...
                    <tr>
                      ...
                      <td class="item-row" v-for="(item, index) in compare" :key="index">
                        ...
                        <form class="variants clearfix">
                          <button title="Add to Cart" class="add-to-cart btn btn-solid" @click="addToCart(item)">Add to
                            Cart</button>
                        </form>
                    ...
                    <tr>
                      ...
                      <td class="item-row" v-for="(item, index) in compare" :key="index">
                        <p class="description-compare">{{ item.description }}</p>
                      </td>
                    </tr>
                    <tr>
