<template>
 <Header/>
    <WidgetsBreadcrumbs title="sitemap" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-6">
                    ...
                    <ul class="">
                        <li><a href="category-page.html"> New
                                demos</a>
                            <ul>
                        ...
                        <li><a target="_blank" href="watch.html">
                                watch</a></li>
                        <li><a target="_blank" href="shoes.html">
                                shoes</a></li>
                        <li><a target="_blank" href="bags.html">
                                bags</a></li>
                        ...
                        <li><a target="_blank" href="beauty.html">
                                beauty</a></li>
                        <li><a target="_blank" href="light.html">
                                light</a></li>
                ...
                <div class="col-md-3 col-6">
                    ...
                    <ul>
                        ...
                        <li><a href="product-page(4-image).html">
                                four image</a></li>
                        <li><a href="product-page(sticky).html">
                                sticky</a></li>
                        <li><a href="product-page(accordian).html">accordian</a></li>
                        <li><a href="product-page(bundle).html">
                ...
                <div class="col-md-3 col-6">
                    ...
                    <ul>
                        ...
                        <li><a href="about-page.html"> about
                                us</a></li>
                        <li><a href="search.html"> search</a></li>
                        <li><a href="typography.html">
                                typography</a></li>
                        <li><a href="review.html"> review</a></li>
                        <li><a href="order-success.html"> order
                                success</a></li>
                        <li>
                            <a href="#"> compare</a>
                            <ul>
                        ...
                        <li><a href="search.html"> site map</a>
                        </li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="element-image-ratio.html">image size ratio <i
                                            class="fa fa-bolt icon-trend" aria-hidden="true"></i></a></li>
